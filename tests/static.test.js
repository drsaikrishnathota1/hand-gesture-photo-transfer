...
test('V5.3.1 UI exposes one universal room workflow with no transfer-mode selector', () => {
...
test('server exposes V5.3.1 health endpoint and universal-room live KPIs', () => {
  assert.match(server, /version: '5\.3\.1'/);
