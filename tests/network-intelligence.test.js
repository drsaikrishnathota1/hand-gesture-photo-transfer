...
test('V5.3.2 masks IPv4 rather than exposing a full public address', () => {
  assert.equal(maskIp('73.184.122.57'), '73.184.xxx.xxx');
  assert.notEqual(maskIp('73.184.122.57'), '73.184.122.57');
});

test('V5.3.2 recognizes loopback, private and public network classes', () => {
...
test('V5.3.2 UI includes Receiver Network Intelligence without a full-IP field', () => {
...
test('V5.3.2 browser code collects device and network signals and measures server latency', () => {
